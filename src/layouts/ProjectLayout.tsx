...
export default function ProjectLayout() {
  ...
  const contentHeightClass = scrollAtShell
    ? ""
    : layoutConfig.height === "full"
      ...
      : layoutConfig.height === "auto"
        ? ""
        : "min-h-0";
  const contentOverflowClass = scrollAtShell
    ? "overflow-visible"
  ...
  return (
    <div className="relative h-screen overflow-hidden bg-gray-50 dark:bg-[#111111]">
      ...
      {theme === "dark" && (
        <>
          <div className="pointer-events-none fixed top-[20%] left-[10%] h-[300px] w-[300px] rounded-full -z-10 bg-[radial-gradient(circle,_rgba(92,141,255,0.10)_0%,_transparent_70%)] animate-[float_6s_ease-in-out_infinite]" />
          <div className="pointer-events-none fixed bottom-[20%] right-[10%] h-[200px] w-[200px] rounded-full -z-10 bg-[radial-gradient(circle,_rgba(64,255,255,0.10)_0%,_transparent_70%)] animate-[float_8s_ease-in-out_infinite_reverse]" />
        </>
      )}
      ...
      />
      <div
        className={`mx-auto w-[calc(100%)] pl-[120px] lg:pl-[140px] pt-14 pr-4 lg:pr-6 pb-10 lg:pb-12 flex-grow lg:flex h-[calc(100vh)] ${shellOverflowClass} transition-all duration-300`}
      >
