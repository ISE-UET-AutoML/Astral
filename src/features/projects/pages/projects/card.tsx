...
export default function ProjectCard({ project, getProjects }) {
  ...
  const accentKey = Object.keys(accentConfig).find((key) =>
    taskType?.includes(key),
  );
  ...
  return (
    <div className="relative">
        ...
        <div className="relative px-4 pt-4 pb-2">
          ...
          <div className="relative z-10">
            <div className="flex justify-between items-center mb-4">
              <div
                className={`px-2.5 py-1 rounded-full text-xs font-medium border ${currentStatus.badge}`}
              >
                {projectStatus === "Training" && (
      ...
      {isDeleting && (
        <div className="absolute inset-0 z-20 flex flex-col items-center justify-center gap-2 rounded-2xl bg-white/70 text-gray-600 backdrop-blur-[1px] dark:bg-black/40 dark:text-gray-300">
