...
import { History as HistoryOutlined, CloudDownload as CloudDownloadOutlined, Trophy as TrophyOutlined, Rocket as RocketOutlined, ChartBar as BarChartOutlined, Info as InfoCircleOutlined, FlaskConical as ExperimentOutlined, ChevronDown as DownOutlined } from 'lucide-react'
                            ...
                            <div className="px-5 pb-5">
                                <button
                                    onClick={async () => {
                                        ...
                                        if (urlResponse.status !== 200) toast.error("Failed to download model.")
