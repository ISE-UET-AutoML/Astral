...
import { logoutLabelStudio } from 'src/features/labels/api/labelProject'
import { getMe } from 'src/features/admin/api/user'
...
function useAuth() {
	...
	const writeCookies = ({ accessToken, refreshToken, userId }: LoginPayload) => {
		const cookieOptions: CookieOptions = {
			path: '/',
			// secure: true,
			// sameSite: 'none',
		}
		if (import.meta.env.VITE_DOMAIN_NAME) {
			cookieOptions.domain = import.meta.env.VITE_DOMAIN_NAME
		}
