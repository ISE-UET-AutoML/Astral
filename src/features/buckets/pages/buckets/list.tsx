...
import { Archive as ArchiveBoxIcon } from "lucide-react";
import { Plus as PlusIcon } from "lucide-react";
import { REGION } from "src/constants/cloudRegion";
    ...
    <>
      ...
      >
        <div className="flex items-center mt-3">
          <button
            onClick={() => updateBucketState({ showUploader: false })}
          ...
          <h1 className="font-bold ml-3 text-xl">Create New Bucket</h1>
        </div>
        <form className="space-y-5" action="#" onSubmit={handleCreateBucket}>
          {/* Service selection */}
          <div className="">
            <label
              htmlFor="visibility"
            ...
            <div className="flex w-full mt-1 bg-white">
              ...
              >
                ...
                />
                <span className="ml-2">Google Cloud Storage</span>
              </button>
              <button
                className={`flex items-center space-x-2 ml-3 px-2 py-2 w-1/2 border rounded-md ${
                  service === "AWS_S3" ? "border-blue-500" : "border-gray-300"
                }`}
