...
const SelectTargetColMulti = () => {
  ...
  const sendColumn = async () => {
    try {
      ...
      const res = await projectAPI.sendTargetColumn(projectInfo._id, formData);
      if (res.status === 200) {
        toast.success("Target Column Set Successfully", 3);
        navigate(`/app/project/${projectInfo._id}/build/selectInstance`);
      }
    } catch (error) {
      console.error("Error sending target column:", error);
      toast.error("Failed to set target column. Please try again.");
    }
  };
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div>
              <div className="mb-2 flex items-center gap-3">
                ...
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent>
                      Select the column that contains the target data for
                      analysis.
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
              ...
              <select
                ...
                onChange={(e) => setSelectedTargetCol(e.target.value || null)}
              >
            ...
            <div>
              <div className="mb-2 flex items-center gap-3">
                ...
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent>
                      Select the column that contains image URLs or paths.
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
              </div>
              <select
                ...
                onChange={(e) => setSelectedImgCol(e.target.value || null)}
              >
