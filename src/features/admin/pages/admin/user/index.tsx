...
import {
	getUserProjects, getDatasetsByProjectId, getExperimentsByProjectId, getModelsByExperimentId, getModelDeploysByModelId, getUserDatasets, getUserInfo } from 'src/features/admin/api/user'
import {
	ArrowLeftIcon, User as UserIcon, Mail as EnvelopeIcon, Calendar as CalendarIcon, Clock as ClockIcon, Folder as FolderIcon, Grid2x2 as Squares2X2Icon, Archive as ArchiveBoxIcon, Rocket as RocketLaunchIcon, ChartBar as ChartBarIcon } from 'lucide-react'
...
const AdminUserDetail = () => {
	...
	if (loading) {
		return (
				<div className="min-h-screen flex items-center justify-center bg-[#01000A]">
	...
	return (
			<div className="min-h-screen bg-[#01000A] font-poppins">
			{/* Header */}
			...
			<div className="max-w-7xl mx-auto px-6 py-8">
				{/* User Info Card */}
					<div className="backdrop-blur-xl rounded-2xl p-8 border border-white/10 mb-8 bg-white/[0.04]">
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
						{statsCards.map((stat, index) => {
							...
							return (
									<div
										key={index}
										className="backdrop-blur-xl rounded-2xl p-6 border border-white/10 bg-white/[0.04]"
									>
				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
					{/* Most Active Task Types */}
						<div className="backdrop-blur-xl rounded-2xl p-8 border border-white/10 bg-white/[0.04]">
