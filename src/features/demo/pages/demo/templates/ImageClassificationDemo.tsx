...
import {
	CheckCircleIcon, CircleX as XCircleIcon, ChevronLeft as ChevronLeftIcon, ChevronRight as ChevronRightIcon, Trash as TrashIcon, Upload as ArrowUpTrayIcon, RefreshCw as ArrowPathIcon, Camera as CameraIcon, Image as PhotoIcon, ArrowRight as ArrowRightIcon } from 'lucide-react'
					...
					<div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-200/50 dark:border-gray-700/50 overflow-hidden">
						...
						<div className="p-8 space-y-8">
							...
							<div className="hidden md:block">
								...
								{activeTab === 'camera' && (
									<div className="space-y-4 mt-8 animate-in fade-in slide-in-from-top-4 duration-500">
											<div className="relative bg-black rounded-2xl overflow-hidden shadow-2xl ring-2 ring-gray-200 dark:ring-gray-700 aspect-video">
											<video
												ref={videoRef}
												autoPlay
												playsInline
