...
import {
	CheckCircleIcon, CircleX as XCircleIcon, Trash as TrashIcon, RefreshCw as ArrowPathIcon, FileText as DocumentTextIcon, SlidersHorizontal as AdjustmentsHorizontalIcon, Download as ArrowDownTrayIcon, Upload as ArrowUpTrayIcon } from 'lucide-react'
													...
													.map((column) => {
														...
														return visibleColumns.includes(
															column
																...
																<th
																	key={column}
																	className="px-6 py-4 text-left text-xs font-semibold text-gray-700 dark:text-gray-300 tracking-wider min-w-[250px]"
																>
																{column}
															</th>
														) : null
																...
																return visibleColumns.includes(
																	column
																		...
																		<td
																			...
																			className="px-6 py-4 text-sm text-gray-900 dark:text-gray-100 whitespace-nowrap group/cell relative max-w-[250px]"
																		>
																		<span
