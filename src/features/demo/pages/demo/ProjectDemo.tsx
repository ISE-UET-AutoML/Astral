...
import ImageClassificationDemo from 'src/features/demo/pages/demo/templates/ImageClassificationDemo'
import TextClassificationDemo from 'src/features/demo/pages/demo/templates/TextClassificationDemo'
import MultilabelTextClassificationDemo from 'src/features/demo/pages/demo/templates/MultilabelTextClassificationDemo'
import TabularClassificationDemo from 'src/features/demo/pages/demo/templates/TabularClassificationDemo'
import TabularRegressionDemo from 'src/features/demo/pages/demo/templates/TabularRegressionDemo'
import MultilabelTabularClassificationDemo from 'src/features/demo/pages/demo/templates/MultilabelTabularClassificationDemo'
import AudioClassificationDemo from 'src/features/demo/pages/demo/templates/AudioClassificationDemo'
		...
		const loadMetadata = async () => {
			try {
				...
				const metadataModule = await import(
					`src/features/demo/pages/demo/metadata/${projectId}.json`
				)
