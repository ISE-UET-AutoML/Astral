...
const TreePanel = ({ tree, onOpen }) => {
	return (
		<div className="flex flex-col h-full min-h-0 bg-white dark:bg-[#252526] border-r border-gray-200 dark:border-[#333]">
			...
			<div className="flex-1 min-h-0 overflow-y-auto p-3 text-sm text-gray-700 dark:text-[#cccccc] bg-white dark:bg-[#252526] [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-thumb]:bg-[#555] [&::-webkit-scrollbar-thumb]:rounded-full">
