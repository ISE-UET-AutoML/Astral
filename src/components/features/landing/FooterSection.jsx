...
const FooterSection = () => {
	return (
		<footer className="relative">
			...
			<section className="py-24 relative bg-[#1a1a1a] z-[20]">
				<ContentContainer>
					<div className="text-center">
						<p 
							className="text-gray-400 text-sm mb-4 uppercase tracking-wider font-poppins"
						>
							Getting Started
						</p>
						<h2 
						...
						<p 
							className="text-gray-400 text-lg mb-8 max-w-2xl mx-auto font-poppins"
						>
				...
				<ContentContainer>
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
						...
						<div className="lg:col-span-2">
							<div className="mb-4">
								<h3 
									className="text-3xl font-bold text-gray-900 font-['Russo_One',_sans-serif]"
								>
									ASTRAL
								</h3>
								<p 
									className="text-gray-600 mt-2 font-poppins"
								>
						...
						<div>
							<h4 
								className="font-bold text-gray-900 mb-4 font-poppins"
							>
								Home
							</h4>
