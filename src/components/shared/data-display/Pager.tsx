...
export default function Pager({ currentPage = 1, totalItems = 0, pageSize = 10, onPageChange }: PagerProps) {
    // Derived values
    ...
    const Button = ({ children, onClick, disabled, active = false, ariaLabel }: PagerButtonProps) => (
        <button
